...
/**
 * Filtre de recherche de type GREATER THAN OR EQUALS
 * @param <T> Type de données
 */
@NoArgsConstructor
public class FilterGreaterThanOrEquals<T extends Comparable<T>> extends Filter<T> {

    /**
     * Création d'un filtre de type GREATER THAN OR EQUALS
     ...
     */
    public static <T extends Comparable<T>> FilterGreaterThanOrEquals<T> of(SearchField<T> searchField, String ...fieldNames) throws ValidationException {
        return Filter.of(FilterGreaterThanOrEquals::new, searchField, fieldNames);
    }
